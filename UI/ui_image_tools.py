                ...
                with gr.Row():
                    ...
                    with gr.Column():
                        with gr.Accordion(label="Face restoration",open=False):                           
                            ...
                            with gr.Row():
                                point_x = gr.Slider(0, 1024, value=64, label="X Axis", step=64,interactive=True)
                                point_y = gr.Slider(0, 1024, value=64, label="Y Axis", step=64,interactive=True)
